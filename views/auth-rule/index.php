...
/** @var app\modules\yii2RbacManager\models\search\AuthRule $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = Yii::t('AuthRule', 'Auth Rules');
...
<div class="auth-rule-index">
    ...
    <p>
        <?= Html::a(Yii::t('AuthRule', 'Create Auth Rule'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
